...
/**
 参考サイト: https://uskeblog.com/create-dentaku-app/
 TODO: ZStack, VStack, HStackについて
 TODO: Viewの分割・読み込みについて
 TODO: @Stateと@Bindingについて
 */
...
struct ContentView: View {
    ...
    private let calculaterItems: [[String]] = [
        ["AC", "+/-", "%", "÷"],
        ["7", "8", "9", "×"],
        ["4", "5", "6", "-"],
        ["1", "2", "3", "+"],
    ...
    var body: some View {
        ...
        ZStack {
            ...
            VStack {
                ...
                VStack {
                    ForEach(calculaterItems, id: \.self) { items in
...
struct NumberView: View {
    ...
    private func handleButtonInfo(item: String) {
        ...
        // 数字が入力されたとき
        if numbers.contains(item) {
            // "."入力されて、かつ入力済みの値に"."が含まれるもしくは"0"の場合は、追加しない
